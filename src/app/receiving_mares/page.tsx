  ...
  return (
    <div className="min-h-screen w-full flex bg-amber-50">
      ...
      <div className="flex-1 px-4 md:px-12 pt-8">
        <div>
          <h1 className="text-4xl text-amber-950">Receptoras</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="w-64 md:w-80 p-24 rounded-lg bg-amber-100 cursor-pointer hover:bg-amber-200 transition-colors">
              <div className="flex flex-col items-center justify-center">
                <i className='bx bx-injection text-2xl md:text-4xl mb-2'></i>
                <h1 className="text-xl text-amber-950 text-center">Registrar Receptora</h1>
              </div>
            </div>
            ...
            <div className="w-64 md:w-80 p-24 rounded-lg bg-amber-100 cursor-pointer hover:bg-amber-200 transition-colors">
              <div className="flex flex-col items-center justify-center">
                ...
                <h1 className="text-xl text-amber-950 text-center">Visualizar Receptoras</h1>
              </div>
            </div>
          </div>
        </div>
